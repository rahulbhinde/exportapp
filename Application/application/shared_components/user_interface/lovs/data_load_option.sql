...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(162993779142433734)
,p_lov_name=>'DATA_LOAD_OPTION'
,p_lov_query=>'.'||wwv_flow_imp.id(162993779142433734)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(162994240073433751)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Upload file, comma separated or tab delimited'
,p_lov_return_value=>'UPLOAD'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(162994645210433755)
