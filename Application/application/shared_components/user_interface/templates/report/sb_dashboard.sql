prompt --application/shared_components/user_interface/templates/report/sb_dashboard
begin
--   Manifest
--     ROW TEMPLATE: SB_DASHBOARD
--   Manifest End
...
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(97704161484509565)
,p_row_template_name=>'SB Dashboard'
,p_internal_name=>'SB_DASHBOARD'
,p_row_template1=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="db2_container" style="background-color:#CONTAINER_CLASS#">',
'    <div class="db2_main">',
...
'        <a style="color:#000" href="#LINK#"><i class="fa #ICON_CLASS#"></i></a>',
'    </div>        ',
'</div>'))
