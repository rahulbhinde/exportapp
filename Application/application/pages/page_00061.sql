...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(109489623806271349)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(109489923367271349)
,p_plug_name=>'Data / Table Mapping'
,p_parent_plug_id=>wwv_flow_imp.id(109489623806271349)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'data_load_def_id', wwv_flow_imp.id(109467069992271316))).to_clob
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(109491120702271350)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(109489623806271349)
,p_button_name=>'NEXT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(109490856041271350)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(109490357686271350)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(109492012187271351)
,p_branch_action=>'f?p=&APP_ID.:62:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(109491120702271350)
...
'                                      where name = ''Proforma Data Load'' and application_id = apex_application.g_flow_id )',
'                            loop',
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(109492444376271351)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(109491660390271350)
...
,p_process_when_button_id=>wwv_flow_imp.id(109491120702271350)
,p_internal_uid=>109542810021099846
);
